...
public class WordDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(com.example.wordsapp.R.layout.fragment_word_detail, container, false);
        Log.v(TAG,mID);

        com.example.wordsapp.WordsDB wordsDB= com.example.wordsapp.WordsDB.getWordsDB();

        if(wordsDB!=null && mID!=null){
            TextView textViewWord=(TextView)view.findViewById(com.example.wordsapp.R.id.word);
            TextView textViewWordMeaning=(TextView)view.findViewById(com.example.wordsapp.R.id.wordmeaning);
            TextView textViewWordSample=(TextView)view.findViewById(com.example.wordsapp.R.id.wordsample);
