...
public class WordsDB {
    ...
    private static com.example.wordsapp.WordsDBHelper mDbHelper;
    ...
    private WordsDB() {
        if (mDbHelper == null) {
            mDbHelper = new com.example.wordsapp.WordsDBHelper(com.example.wordsapp.WordsApplication.getContext());
        }
    }
    ...
    public void InsertUserSql(String strWord, String strMeaning, String strSample) {
        ...
        db.execSQL(sql, new String[]{com.example.wordsapp.GUID.getGUID(),strWord, strMeaning, strSample});
    }
    ...
    public void Insert(String strWord, String strMeaning, String strSample) {
        ...
        values.put(Words.Word._ID, com.example.wordsapp.GUID.getGUID());
